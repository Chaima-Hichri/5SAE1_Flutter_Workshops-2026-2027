...
import 'package:flutter_workshops_5sae1_2627/widgets/FilmCardListViewItem.dart';
...
class GStoreListView extends StatefulWidget {
  ...
  @override
  State<GStoreListView> createState() => _GstoreState();
}

class _GstoreState extends State<GStoreListView> {
    ...
    return  Scaffold(
      ...
      body:ListView.builder(
        itemCount: films.length,
          ...
          return FilmCardListViewItem(title: films[index].title, imagepath: films[index].image);
          })
    );
  }
}
